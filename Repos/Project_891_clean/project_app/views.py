...
from project_app.forms import CreateCourseForm, EditCourseForm, CreateSectionForm, EditSectionForm, CreateUserForm,    EditUserForm, UpdateProfileForm, ChangePasswordForm
